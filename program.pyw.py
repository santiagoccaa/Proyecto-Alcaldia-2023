...
nombre=Label(framecontenido, text="Nombre:", font=("Poppins 15"), bg='#CEFFFF').place(x=400, y=115) # titulo nombre
nentry=Entry(framecontenido, font=("Poppins 14"), justify=CENTER, textvariable=datonombre).place(x=410, y=150) # caja de texto para escribir nombre

#---apellido-----------------------------------------------------------------------
datoapellido=StringVar()

apellidos=Label(framecontenido, text="Apellido:", font=("Poppins 15"), bg='#CEFFFF').place(x=400, y=195) #titulo apellido
aentry=Entry(framecontenido, font=("Poppins 14"), justify=CENTER, textvariable=datoapellido).place(x=410, y=230) #caja de texto para escribir apellido
#---cedula------------------------------------------------------------------------
datocedula=StringVar()

cedula=Label(framecontenido, text="Numero CC:", font=("Poppins 15"), bg='#CEFFFF').place(x=400, y=275) #titulo cedula
centry=Entry(framecontenido, font=("Poppins 14"), justify=CENTER, textvariable=datocedula).place(x=410, y=310) # caja para escribir la cedula
